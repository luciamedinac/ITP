...
start_time = np.datetime64("2023-02-13T02:59:14")
end_time = np.datetime64("2023-02-13T02:59:26")
...
for key in node_config.keys():
    ...
    folder_path = '/Users/tjr2099/Library/CloudStorage/OneDrive-UniversityofBath/Physics w Astro Year 4/Industry Team Project/Arrival Time Difference Practice/fireball_data/Bath_VLF_2023_decoded/2023-09-23/'
    # Create list of file paths for each file in the folder
    file_list = glob.glob(folder_path + "*" + key + '*20230923*.npy')
...
for study_time in study_times:
    ...
    fig, axs = plt.subplots(len(datadict) - 3,
                            figsize=(15, 20),
                            sharex=True,
